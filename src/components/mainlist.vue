<template>
  <div id="app">
    ...
    <div class="book">
      ...
      <div class="row" v-for="(item, index) in notes" :key="index">
        <div class="col-1">{{item.id}}</div>
        <div class="col-2">{{item.first_name}}</div>
        <div class="col-3"> {{item.second_name}}</div>
        <div class="col-3"> {{item.third_name}}</div>
        <div class="col-3">{{item.phone}} <span v-if="item.favorite"> ★</span> </div>
      </div>
